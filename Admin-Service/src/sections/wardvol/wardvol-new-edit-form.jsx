  ...
  return (
    ...
    >
      <Grid container spacing={3}>
        <Grid xs={12} md={8}>
          <Card sx={{ p: 3 }}>
            ...
            >
              <RHFTextField name="tripSource" label="Trip Source" />
              <RHFTextField name="tripDestination" label="Destination" />
              {/* <RHFAutocomplete
                name="userId"
                label="User Name"
      ...
      // }
              ...
              <Stack spacing={1.5}>
                <RHFTextField name="tripDetails" fullWidth label="TripDetails" multiline rows={4} />
              </Stack>
            </Box>
