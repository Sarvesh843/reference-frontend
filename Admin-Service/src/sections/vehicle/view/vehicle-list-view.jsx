...
import ProductTableFiltersResult from '../vehicle-table-filters-result'; // Changed to vehicle-table-filters-result
import {
  RenderCellStock,
  RenderCellPrice,
  RenderCellProduct,
...
export default function VehicleListView() {
  ...
  const { vehicles, vehiclesLoading } = useGetVehicles(); // Changed to useGetVehicles
  ...
  const handleDeleteRow = useCallback(
    async (id) => {
      try {
        ...
        const apiUrl = `/vehicle/delete/${id}`; // Changed to vehicle
            ...
            slots={{
              toolbar: () => (
                <>
                  ...
                  {canReset && (
                    <ProductTableFiltersResult // Changed to vehicle-table-filters-result
                      filters={filters}
