...
import CategoryReviewNewForm from './category-review-new-form';

// ----------------------------------------------------------------------

export default function CategoryDetailsReview({ totalRatings, totalReviews, ratings, reviews }) {
  ...
  return (
    <>
      ...
      <CategoryReviewList reviews={reviews} />

      <CategoryReviewNewForm open={review.value} onClose={review.onFalse} />
    </>
  );
}

CategoryDetailsReview.propTypes = {
