...
export default function WardLeaderDetailsView({ id }) { // Changed function name to TripDetailsView
        ...
        <Stack sx={{ maxWidth: 720, mx: 'auto' }}>
          <Stack direction="column" alignItems="start">
            ...
            <Stack direction="row" alignItems="start" sx={{ marginTop: '10px' }}>
              ...
              <Typography sx={{ ml: 1 }}> {tripData?.User?.DriverDetail? tripData?.User?.DriverDetail?.fullName:'Not Assigned'}</Typography>
            </Stack>
            <Stack direction="row" alignItems="start" sx={{ marginTop: '10px' }}>
              <Typography sx={{ mr: 1, minWidth: 180 }}>Vehicle Number:</Typography>
              <Typography sx={{ ml: 1 }}> {tripData?.VehicleDetail? tripData?.VehicleDetail?.licensePlate:'Not Assigned'}</Typography>
            </Stack>
          </Stack>
