...
import ClaimReviewNewForm from './claim-review-new-form';

// ----------------------------------------------------------------------

export default function ClaimDetailsReview({ totalRatings, totalReviews, ratings, reviews }) {
  ...
  return (
    <>
      ...
      <ClaimReviewList reviews={reviews} />

      <ClaimReviewNewForm open={review.value} onClose={review.onFalse} />
    </>
  );
}

ClaimDetailsReview.propTypes = {
