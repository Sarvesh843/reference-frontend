...
export default function AmbulanceTripDetailsView({ id }) { // Changed function name to TripDetailsView// Changed to useGetTrip
      ...
      <Container maxWidth={false}>
        <Stack sx={{ maxWidth: 720, mx: 'auto' }}>
          <Stack direction="column" alignItems="start">
            ...
            <Stack direction="row" alignItems="start" sx={{ marginTop: '10px' }}>
              <Typography sx={{ mr: 1, minWidth: 180 }}>Pickup Address:</Typography>
              <Typography sx={{ ml: 1 }}> {tripData?.tripSource}</Typography> 
            </Stack>
            <Stack direction="row" alignItems="start" sx={{ marginTop: '10px' }}>
              <Typography sx={{ mr: 1, minWidth: 180 }}>Drop Address:</Typography>
