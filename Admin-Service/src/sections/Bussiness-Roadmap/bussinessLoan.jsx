...
export default function LoanForBussness({ currentTab }) {
  // const theme = useTheme();
  const cardsData = [
   
    { id: 1, title: 'AttplFinence ', description: 'Offers advice, insights, and resources for small business owners and entrepreneurs in India', navigate: 'https://www.entrepreneurindia.com', icon: 5, path: "/assets/images/business/Entreprenuer.png"},
